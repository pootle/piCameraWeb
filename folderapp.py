...
class fileManager(wv.watchableApp):
    def __init__(self, basefolder, childdefs=None, **kwargs):
    ...
    def make_page(self, pagelist, qp, pp):
        ...
        return {'resp':200, 'headers': (('Content-Type', 'text/html; charset=utf-8'),), 'data': page.format(stuff=c)}
...
page="""<html><head>\n
<link rel="stylesheet" href="static/filebits.css">
<script src="static/filebits.js"></script>
