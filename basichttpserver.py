    ...
    def close(self):
        for closefunc in self.config['oncloseapps']:
            try:
                ...
                self.log(logging.WARN,'service close exception', exc_info=True, stack_info=True)
...
class httprequh(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            ...
            return
        queryparams={} if parsedpath.query=='' else parse_qs(parsedpath.query)
