...
gpioFields=(
    ...
    {'app': 'camera', 'varlocal': 'steadytime', 'fieldmaker': htmlmaker.make_numVar, 'updclass': htmlmaker.varintupdater, 'userupa':'user',
            'label': 'deglitch time', 'shelp': 'time (microseconds) pin must remain high before triggering. 0 for no delay'},
    {'app': 'camera', 'varlocal': 'holdtime', 'fieldmaker': htmlmaker.make_numVar, 'updclass': htmlmaker.varintupdater, 'userupa':'user',
            'label': 'hold time', 'shelp': 'time (microseconds) trigger will hold '},
...
recordfields=(
    ...
    {'app': 'camera', 'varlocal': 'splitrecord', 'fieldmaker': htmlmaker.make_numVar, 'updclass': htmlmaker.varfloatupdater, 'userupa':'user',
            'label': 'split recordings at', 'shelp': 'when recording, start a new file after this many minutes - 0 means never split.'},
    {'app': 'camera', 'varlocal': 'maxvidlength', 'fieldmaker': htmlmaker.make_numVar, 'updclass': htmlmaker.varintupdater, 'userupa':'user',
            'label': 'max video length', 'shelp': 'when converting the recorded X264 files to mp4 files, split the file after this many split files'},
